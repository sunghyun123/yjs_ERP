...
> 최종 업데이트: 2026-07-02 (레포 위생 + DB 타입 never-collapse 수리 — as any 44곳 제거)
>
> 이 문서는 2층 구조다.
...
**결과:** lint 72→22(에러 62→8), tsc 0, 테스트 75/75, 프로덕션 빌드 통과. 남은 에러 8건은 전부 effect 내 동기 setState — 동작(타이핑 떨림 방지 등)이 걸린 로직이라 다음 작업 단위로 분리.
